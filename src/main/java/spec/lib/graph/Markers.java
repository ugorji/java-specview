...
/**
 * This class installs, manipulates and draws markers. Markers are stroked using the line drawing
 * method of the class Graph. This means that any stroked figure can become a marker.
 *
...
public class Markers extends Object {
  ...
  /**
   * An array of vectors. Each element in the array contains the vertex vectors for a marker. Marker
   * 1 is at element vert[0].
   */
  ...
  /**
   * Instantiate the Marker class and load marker definitions from the parsed URL. The format of the
   * file is easily worked out from the default marker file <a href="marker.txt">marker.txt</a>.
   *
  ...
  /**
   * Add the definition of a new marker. The arrays contain the vertex points of the marker. The
   * boolean array is used to define a relative draw or move to the vertex. The first vertex should
   * always be a move (The boolean array is "true" for a relative draw.
   *
   * @param m The index of the marker. The first marker has index 1.
   * @param n The number of vertices required to stroke the marker.
   * @param draw Boolean array containing relative move/draw instructions. "true" is a draw.
   * @param x Integer array containing the pixel x position of the vertices. All positions are
  ...
  /**
   * Add the definition of a new marker. The new marker is appended onto the marker list. The center
   * of the marker is assumed to be at (0,0).
   *
   * @param n number of move/draw commands
   * @param draw <i>true</i> if the point is to drawn to, <i>false</i> if the point is to be moved
   *     to.
  ...
  /**
   * This method reads the marker file and loads the marker definitions. The format of the file is
   * simple. The following are the keywords.
   *
   * <dl>
   *   <dt><b>start</b>
   ...
   * </dl>
   *
   * All line drawing is relative to the previous position. The center of the marker is assumed to
   * be at (0,0). As always blank lines are ignored and comments begin with a # character.
   *
