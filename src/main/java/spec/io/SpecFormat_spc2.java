...
public class SpecFormat_spc2 extends SpecFormat implements Cloneable, Serializable {
  public SpecFormat_spc2() {
    super();
  }

  public String toString() {
    return "NEW SPCLIB FORMAT";
  }

  /** get the default extension for this spectrum format */
  public String getExtension() {
    return SpecConstants.EXTENDED_SPC_FORMAT_EXTENSION;
  }
